 ...
 public class Employee{
  ...
  public static void main(String[] args){
    Employee e1 = new Employee("Robert", 1994, 1000000, "64C- WallsStreet");
    Employee e2 = new Employee("Sam", 2000, 10101010, "68d- WallsStreet");
    Employee e3 = new Employee("John", 1999, 19191919, "26B- WallsStreet");
